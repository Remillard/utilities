...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="generate_lut",
        description="""Creates a memory initialization file (*.mif) for a sinusoid.""",
    )
    parser.add_argument(
        "-p",
        "--prefix",
    ...
    parser.add_argument(
        "-w",
        "--width",
        help="Data witdth specified in number of data bits.  Default: 16",
        default=16,
        type=int,
    )
    parser.add_argument(
    ...
    filename = "{}_{}x{}_{}_{}_lut.{}".format(
        args.prefix, args.width, depth, args.rotation, args.function, args.format
    )
